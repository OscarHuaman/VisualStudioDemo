namespace CMP.Presentation.OrdenCompra
{
    ...
    public partial class PCMP_ViewOrdenCompra : UserControl, CmpINavigation
    {
        ...
        public object Parameter
        {
            set
            {
                ...
                this.KeyDownCmpButtonTitleTecla(ActionF9: btnImprimirIsClicked,
                                                ActionESC: btnSalirIsClicked);

                MyHeader.DataContext = ObjECMP_OrdenCompra;
                //chkPrecioIncluidoIGV.IsChecked = true;
